// Crie uma função que encapsula o seu programa de somar arrays e utiliza o operador REST para captar os argumentos da função. 
...
const array2 = sumarray(array,array1);
